...
def get_port():
	...
	cmd['port']['home'] = ("司令、しっかり食べてるか？", (47, 48), (25, 25))
	cmd['port']['go'] = ("第十七驅逐艦隊磯風，參上！", (195, 263), (40, 40))
	cmd['port']['ok'] = ("選擇遠征", (678, 444), (3, 3))
	cmd['port']['poi'] = ("どうした。", (623, 282), (3, 3))
	return cmd
...
def get_refill():
	...
	cmd['refill']['f1'] = ("f1", (148, 120), (3, 3))
	cmd['refill']['f2'] = ("f2", (179, 120), (3, 3))
	cmd['refill']['f3'] = ("f3", (207, 120), (3, 3))
	cmd['refill']['f4'] = ("f4", (238, 120), (3, 3))
